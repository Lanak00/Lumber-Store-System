    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    UMCN = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Image = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuttingLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CuttingLists_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CuttingLists_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuttingListItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CuttingListItems_CuttingLists_CuttingListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CuttingListItems_CuttingListId",
                table: "CuttingListItems",
                column: "CuttingListId");

            migrationBuilder.CreateIndex(
                name: "IX_CuttingLists_OrderId",
                table: "CuttingLists",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CuttingLists_ProductId",
                table: "CuttingLists",
                column: "ProductId");
